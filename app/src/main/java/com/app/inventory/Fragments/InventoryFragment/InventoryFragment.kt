package com.app.inventory.Fragments.InventoryFragment
...
class InventoryFragment : Fragment(), AdapterView.OnItemSelectedListener {
    ...
    private var arraylistdata: ArrayList<SpinnerInventoryYearModel> =
        ArrayList<SpinnerInventoryYearModel>()
